...
$name = ((!($opt = getopt("o:")) || $opt['o'] === false) ? str_replace(".", "_", ("PlumbokPM_v" . $metadata['version'])) . ".phar" : $opt["o"]);
 ...
 * @return Generator
 */
function buildPhar(string $pharPath, string $basePath, array $includedPaths, array $excludedPaths, array $metadata, string $stub, int $signatureAlgo = Phar::SHA1): Generator {
