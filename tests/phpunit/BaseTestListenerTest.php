...
class BaseTestListenerTest extends \PHPUnit\Framework\TestCase
{
	...
	public function testEmptyFileCompile(): void {
		$compiler = new \Octopush\Plumbok\Compiler();
	...
	public function testUnnamespacedFileCompile(): void {
		$correctDocBlock = '/**
 * @Data
 ...
 */';
	 ...
	 */
	public function testRemoveSpaceFromClassTags(string $expected, string $testValue): void {
		$this->assertEquals($expected, \Octopush\Plumbok\TagsUpdater::removeSpaceFromClassTags($testValue));
	}
